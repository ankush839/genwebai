            ...
            {open &&
                ...
                >
                    <motion.div
                        ...
                        className='relative w-full max-w-md p-1 rounded-3xl bg-gradient-to-br
                        ...
                        <div className="relative rounded-3xl bg-[#0b0b0b] border border-white/10 shadow-[0_30px_120px_rgba(0,0,0,0.8)] overflow-hidden">
                            ...
                            <button className='absolute top-5 right-5 z-20 text-zinc-400 hover:text-white tansition text-lg' onClick={onClose}>
                                X
                            </button>
